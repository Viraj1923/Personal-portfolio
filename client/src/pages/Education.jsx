...
import kitCollege from "@/assets/btech.png";
import saiCollege from "@/assets/hsc.png";
import venkatraoCollege from "@/assets/ssc.png";
import {
  GraduationCap,
  Calendar,
  MapPin,
...
const educationData = [
  {
    id: 1,
    school: "KIT's College of Engineering Kolhapur (Empowered Autonomous)",
    ...
    description:
      "Built a strong foundation in computer science, artificial intelligence, machine learning, and software engineering through academic coursework and hands-on projects.",
  },
  {
    id: 2,
    school: "Sai International Jr. College, Gadhinglaj",
    ...
    description:
      "Developed a foundation in analytical thinking and problem-solving, with a focus on science and mathematics.",
  },
  {
    id: 3,
    school: "Venkatrao High. & Jr. College, Ajara",
    location: "Ajara, Maharashtra, India",
    duration: "March 2020",
    degree: "Secondary School Certificate (SSC)",
    grade: "Grade: 93%",
    image: venkatraoCollege,
    subjects: ["Mathematics", "Science", "English"],
    description:
      "Completed secondary education with a strong academic foundation in mathematics, science, and computer fundamentals.",
  },
];
